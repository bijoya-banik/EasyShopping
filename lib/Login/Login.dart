...
import 'package:Easy_Shopping/Registration/Registration.dart';
...
@override
  void initState() {
     _firebaseMessaging.getToken().then((token) async {
      ...
      print(token);
      appToken = token;
       Future.delayed(Duration.zero, this._showAlertDialog);
    ...
    else if (loginEmailController.text.length != 11) {
      print(loginEmailController.text.length);
        ...
        builder: (BuildContext context) {
          ...
          //  titlePadding: EdgeInsets.only(top:15),
            ...
            content: Padding(
              ...
              child: Text(
                "Dear user, we are notifying you that this app will access some features of your phone and that will be 100% safe. You can send your feedback if you have any queries or you don't want to share these features for further use.",
                   style: TextStyle(
                      color: Color(0xFF2A2A2A),
                      fontFamily: "Poppins",
                      fontSize: 18,
